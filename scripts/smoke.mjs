...
assert.deepEqual(cjs.csvToGeoJSON(CSV).features[0].geometry.coordinates, EXPECTED, "CJS conversion");
...
assert.deepEqual(esm.default(CSV).features[0].geometry.coordinates, EXPECTED, "ESM conversion");
